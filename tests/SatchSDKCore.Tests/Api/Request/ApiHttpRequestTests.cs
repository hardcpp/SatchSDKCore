...
namespace SSC.Tests.Api.Request;

/// <summary>
/// Tests for ApiHttpRequest class which wraps HttpServerExRequestContext to provide
/// request handling functionality including header access, IP address retrieval,
/// and body content reading.
/// </summary>
public class ApiHttpRequestTests
{
    /// <summary>
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new ApiHttpRequest(null!));
    }
    ...
    public async Task Constructor_WithValidContext_StoresContext()
    {
        ...
        if (capturedContext != null)
        {
            ...
            var request = new ApiHttpRequest(serverContext);
    ...
    /// <summary>
    /// Verifies that AsApiHttpRequest property from ApiRequest works correctly.
    /// </summary>
    [Fact]
    public async Task AsApiHttpRequest_ReturnsItself()
    {
        // Arrange
        using var listener = new HttpListener();
    ...
    /// <summary>
    /// Verifies that ApiHttpRequest properly inherits from ApiRequest.
    /// </summary>
    [Fact]
    public async Task ApiHttpRequest_InheritsFromIRequest()
    {
        // Arrange
        using var listener = new HttpListener();
