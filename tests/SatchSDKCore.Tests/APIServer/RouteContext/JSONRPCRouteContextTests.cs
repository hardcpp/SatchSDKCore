...
public class JSONRPCRouteContextTests
{
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new JSONRPCRouteContext(null!));
    }
    ...
    public void Constructor_WithValidRequest_StoresRequest()
    {
        ...
        // Act
        var context = new JSONRPCRouteContext(mockRequest);
    ...
    /// <summary>
    /// Verifies that JSONRPCRouteContext inherits from IRouteContext.
    /// </summary>
    [Fact]
    ...
    public void Request_PropertyIsReadOnly()
    {
        ...
        var context = new JSONRPCRouteContext(mockRequest1);
    ...
    public void AddObject_IndependentBetweenContexts()
    {
        // Arrange
        var mockRequest = new MockRequest();
        var context1 = new JSONRPCRouteContext(mockRequest);
        var context2 = new JSONRPCRouteContext(mockRequest);
    ...
    /// <summary>
    /// Verifies that JSONRPCRouteContext and RESTRouteContext are distinct types.
    /// </summary>
    [Fact]
    public void JSONRPCRouteContext_IsDistinctFromRESTRouteContext()
    {
        // Arrange
        var mockRequest = new MockRequest();
        var jsonRpcContext = new JSONRPCRouteContext(mockRequest);

        // Act & Assert
        Assert.NotNull(jsonRpcContext.AsJSONRPCRouteContext);
        Assert.Null(jsonRpcContext.AsRESTRouteContext);
    }
