...
/// WebSocket client
/// </summary>
public class WSClient : WSCommon
{
    ...
    public event Action<WSClient>?
        OnConnected;
    public event Action<WSClient, ReadOnlySpan<byte>, WebSocketMessageType>?
        OnMessage;
    public event Action<WSClient, WebSocketCloseStatus?, string?, bool>?
        OnDisconnected;
